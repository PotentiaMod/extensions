    ...
    class AtomicVisuals {
        ...
        getInfo() {
            return {
                ...
                blocks: [
                    { opcode: 'stopAll', blockType: Scratch.BlockType.COMMAND, text: 'Clear all effects' },
                    {
                        opcode: 'resetEffect',
                    ...
                    { blockType: Scratch.BlockType.LABEL, text: '── Stage special effects ──' },
                    {
                        opcode: 'getStageValue',
                        blockType: Scratch.BlockType.REPORTER,
                        text: 'Current Stage [STAGE_PROPERTY] the value of',
                        arguments: { STAGE_PROPERTY: { type: Scratch.ArgumentType.STRING, menu: 'stageMonitorMenu' } }
                    },
                    {
                        opcode: 'setStageFilter',
                        blockType: Scratch.BlockType.COMMAND,
                        text: 'Set the stageSet the stage [FILTER] Set as [VALUE]',
                        arguments: {
                    ...
                    },
                    {
                        opcode: 'setStage3D',
                        blockType: Scratch.BlockType.COMMAND,
                        text: 'Stage3D Rotate X:[X]° Y:[Y]° Perspective:[P]px',
                        arguments: {
                            X: { type: Scratch.ArgumentType.NUMBER, defaultValue: 0 },
                            Y: { type: Scratch.ArgumentType.NUMBER, defaultValue: 0 },
                    ...
                    },
                    {
                        ...
                        blockType: Scratch.BlockType.COMMAND,
                        text: 'Web page [TRANSFORM2] X:[X] Y:[Y]',
                        arguments: {
                            TRANSFORM2: { type: Scratch.ArgumentType.STRING, menu: 'transform2Menu' },
                            X: { type: Scratch.ArgumentType.NUMBER, defaultValue: 0 },
                            Y: { type: Scratch.ArgumentType.NUMBER, defaultValue: 0 }
                    ...
                    },
                    {
                        opcode: 'setBody3D',
                        blockType: Scratch.BlockType.COMMAND,
                        text: 'Web page3D Rotate X:[X]° Y:[Y]° Perspective:[P]px',
                        arguments: {
                            X: { type: Scratch.ArgumentType.NUMBER, defaultValue: 0 },
                            Y: { type: Scratch.ArgumentType.NUMBER, defaultValue: 0 },
                            P: { type: Scratch.ArgumentType.NUMBER, defaultValue: 800 }
                    ...
                    },
                    {
                        opcode: 'setBgColor',
                        blockType: Scratch.BlockType.COMMAND,
                        text: 'Web page Mask Color:[COLOR] Transparency:[ALPHA]',
                        arguments: {
                    ...
                    },
                    {
                        ...
                        blockType: Scratch.BlockType.COMMAND,
                        text: 'Web page Transformation origin X:[X]% Y:[Y]%',
                        arguments: {
                            X: { type: Scratch.ArgumentType.NUMBER, defaultValue: 50 },
                            Y: { type: Scratch.ArgumentType.NUMBER, defaultValue: 50 }
                        }
                ...
                menus: {
                    stageMonitorMenu: {
                        ...
                        items: ['Hue','Invert','Brightness','Contrast','Saturation','Blur','Grayscale','Sepia','Opacity','Scale','Translate X','Translate Y','Rotate','Skew X','Skew Y','Origin X','Origin Y','3D X','3D Y','Perspective']
                    },
                    bodyMonitorMenu: {
                        acceptReporters: true,
                        items: ['Hue', 'Invert', 'Brightness', 'Contrast', 'Saturation', 'Blur', 'Grayscale', 'Sepia', 'Opacity', 'Scale', 'Translate X', 'Translate Y', 'Rotate', 'Skew X', 'Skew Y', 'Origin X', 'Origin Y', '3D X', '3D Y', 'Perspective', 'Mask Opacity']
                    },
                    resetMenu: {
                        acceptReporters: true,
                        items: ['Stage·All Filters','Stage·All Transforms','Stage·3D Rotation','Stage·Origin','Web page·All Filters','Web page·All Transforms','Web page·3D Rotation','Web page·Mask','Web page·Origin']
                    },
                    filterMenu: {
                        acceptReporters: true,
                        items: ['Hue', 'Invert', 'Brightness', 'Contrast', 'Saturation', 'Blur', 'Grayscale', 'Sepia', 'Opacity']
                    },
                    transform1Menu: {
                        acceptReporters: true,
                        items: ['Scale', 'Rotate']
        ...
        getStageValue(args) {
            ...
            switch (p) {
                case 'Hue': return this.state.sHue;
                case 'Invert': return this.state.sInvert;
                case 'Brightness': return this.state.sBrightness;
                case 'Contrast': return this.state.sContrast;
                case 'Saturation': return this.state.sSaturate;
                case 'Blur': return this.state.sBlur;
                case 'Grayscale': return this.state.sGrayscale;
                case 'Sepia': return this.state.sSepia;
                case 'Opacity': return this.state.sOpacity;
                case 'Scale': return this.state.sScale;
                case 'Translate X': return this.state.sTranslateX;
                case 'Translate Y': return this.state.sTranslateY;
                case 'Rotate': return this.state.sRotate;
                case 'Skew X': return this.state.sSkewX;
                case 'Skew Y': return this.state.sSkewY;
                case 'Origin X': return this.state.sOriginX;
                case 'Origin Y': return this.state.sOriginY;
                case '3D X': return this.state.s3DX;
                case '3D Y': return this.state.s3DY;
                case 'Perspective': return this.state.sPersp;
                default: return 0;
            }
        }
        ...
        getBodyValue(args) {
            ...
            switch (p) {
                case 'Hue': return this.state.bHue;
                case 'Invert': return this.state.bInvert;
                case 'Brightness': return this.state.bBrightness;
                case 'Contrast': return this.state.bContrast;
                case 'Saturation': return this.state.bSaturate;
                case 'Blur': return this.state.bBlur;
                case 'Grayscale': return this.state.bGrayscale;
                case 'Sepia': return this.state.bSepia;
                case 'Opacity': return this.state.bOpacity;
                case 'Scale': return this.state.bScale;
                case 'Translate X': return this.state.bTranslateX;
                case 'Translate Y': return this.state.bTranslateY;
                case 'Rotate': return this.state.bRotate;
                case 'Skew X': return this.state.bSkewX;
                case 'Skew Y': return this.state.bSkewY;
                case 'Origin X': return this.state.bOriginX;
                case 'Origin Y': return this.state.bOriginY;
                case '3D X': return this.state.b3DX;
                case '3D Y': return this.state.b3DY;
                case 'Perspective': return this.state.bPersp;
                case 'Mask Opacity': return this.state.bBgAlpha;
                default: return 0;
            }
        }

        stopAll() {
            // Completely remove all special effects and restore the original style.
            manager.resetAll();
        ...
        resetEffect(args) {
            const e = args.EFFECT;
            switch (e) {
                case 'Stage·All filters':
                    this.state.sHue=0; this.state.sInvert=0; this.state.sBrightness=1; this.state.sContrast=1;
                    this.state.sSaturate=1; this.state.sBlur=0; this.state.sGrayscale=0; this.state.sSepia=0;
                    this.state.sOpacity=1;
                    manager.canvasFilters.clear();
                    break;
                case 'Stage·All transformations':
                ...
                case 'Stage·Origin':
                    ...
                    break;
                case 'Web page·All filters':
                    this.state.bHue=0; this.state.bInvert=0; this.state.bBrightness=1; this.state.bContrast=1;
                    this.state.bSaturate=1; this.state.bBlur=0; this.state.bGrayscale=0; this.state.bSepia=0;
                    this.state.bOpacity=1;
                    manager.bodyFilters.clear();
                    break;
                case 'Web page·All transformations':
