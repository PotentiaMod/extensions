...
(function (Scratch) {
  ...
  class AnessI18n {
      ...
      return {
        ...
        blocks: [
          ...
          },
          {
            ...
            text: Scratch.translate("Language Settings"),
          },
          {
          ...
          },
          {
            ...
            text: Scratch.translate(
              "if a translation is missing, show [TEMPLATE]"
            ),
            arguments: {
              TEMPLATE: {
                type: Scratch.ArgumentType.STRING,
          ...
          },
          {
            ...
            blockType: Scratch.BlockType.COMMAND,
            text: Scratch.translate(
              "forget every translation, for every language"
            ),
            switches: ["clearLocale"],
          },
          {
            blockType: Scratch.BlockType.LABEL,
            text: Scratch.translate("Edit Strings"),
          },
          {
            opcode: "setString",
            blockType: Scratch.BlockType.COMMAND,
          ...
          {
            blockType: Scratch.BlockType.LABEL,
            text: Scratch.translate("Translate"),
          },
          {
            opcode: "translate",
            blockType: Scratch.BlockType.REPORTER,
          ...
          },
          {
            ...
            blockType: Scratch.BlockType.REPORTER,
            text: Scratch.translate(
              "translate [KEY] or use [FALLBACK_TEXT] if missing"
            ),
            disableMonitor: true,
            arguments: {
              KEY: {
          ...
          },
          {
            ...
            blockType: Scratch.BlockType.COMMAND,
            text: Scratch.translate(
              "load translations for [LOCALE] from [CATALOG_JSON]"
            ),
            arguments: {
              LOCALE: {
                type: Scratch.ArgumentType.STRING,
          ...
          },
          {
            ...
            blockType: Scratch.BlockType.REPORTER,
            text: Scratch.translate(
              "translate [KEY], filling in named values [PAIRS]"
            ),
            disableMonitor: true,
            arguments: {
              KEY: {
                type: Scratch.ArgumentType.STRING,
                defaultValue: "greeting.hey",
              },
              PAIRS: {
                type: Scratch.ArgumentType.EXTENDABLE,
    ...
    hasString(args) {
      ...
      return !!(
        catalog &&
        Object.prototype.hasOwnProperty.call(catalog, Cast.toString(args.KEY))
      );
    }
    ...
    deserialize(data) {
      ...
      if (saved.missingKeyTemplate)
        missingKeyTemplate = saved.missingKeyTemplate;
    }
  }
