  ...
  class Files {
    getInfo() {
      return {
        ...
        blocks: [
          {
            opcode: "FilesUtil_areFilesUsable",
            blockType: Scratch.BlockType.BOOLEAN,
            text: "can files be used?",
          },
          {
            opcode: "FilesUtil_showPicker",
          ...
          {
            opcode: "FilesUtil_showPickerExtensions",
            blockType: Scratch.BlockType.REPORTER,
          ...
          {
            opcode: "FilesUtil_showPickerExtensionsAs",
            blockType: Scratch.BlockType.REPORTER,
